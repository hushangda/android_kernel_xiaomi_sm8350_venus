...
struct erofs_sb_info {
	...
	/* special inode containing compressed fragments */
...
/* Used internally to find a compressed tail extent. */
#define EROFS_GET_BLOCKS_FINDTAIL	0x0002
...
struct page *__erofs_allocpage(struct list_head *pool, gfp_t gfp,
				   bool try_reserve);
static inline struct page *erofs_allocpage(struct list_head *pool,
					      gfp_t gfp)
{
